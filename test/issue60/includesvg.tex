...
\pandocbounded{\includegraphics{svg-inkscape/bubbleup_svg-raw}}

\pandocbounded{\includesvg{bubbleup}}

\pandocbounded{\includegraphics{svg-inkscape/svg-example_svg-tex}}

\pandocbounded{\includesvg{svg-example}}
%\pandocbounded{\includegraphics{<graphic-file>}}
%\pandocbounded{\includesvg{<svg-file>}}
\end{document}
